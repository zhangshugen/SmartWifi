...
public class SharedPreferencesUtil {
    ...
    public static SharedPreferencesUtil getInstance() {
        if (spu == null) {
            spu = new SharedPreferencesUtil(UIUtils.getContext().getApplicationContext());
        }
        return spu;
    }

    /**
     * @param key 键值名    * @param b    设置boolean值
     */
    ...
    /**
     * @param key 键名    * @param b    默认返回值    * @return boolean值
     */
    ...
    /**
     * @param key 键名    * @param defult   默认返回值    * @return 字符串
     */
    ...
    /**
     * @param key 键名    * @param defult   默认返回int值    * @return int
     */

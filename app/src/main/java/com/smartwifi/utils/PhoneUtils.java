...
public class PhoneUtils {
    ...
    public static final String PHONE_BRAND_HONOR = "HONOR";
...
*/
     ...
     * @param _uri    电话号码
     */
    public static void call(Context context, Uri _uri) {
        context.startActivity(new Intent(Intent.ACTION_DIAL, _uri));
    }
    ...
    public static JSONArray getLocalContactsInfos(Context context) {
        ...
        while (cursor.moveToNext()) {
            ...
            while (b) {
                PhoneNumber = phone.getString(phone.getColumnIndex(ContactsContract
     ...
     * @return
     */
    public static JSONArray getLocalContactsInfos(Context context, int pageSize, int
            currentOffset) {
        ...
        Cursor cursor = cr.query(ContactsContract.Contacts.CONTENT_URI, null, "sort_key COLLATE " +
                "LOCALIZED asc limit " + pageSize + " offset " + currentOffset, null, null);
        while (cursor.moveToNext()) {
            //取得联系人名字
            int nameFieldColumnIndex = cursor.getColumnIndex(ContactsContract.PhoneLookup
                    .DISPLAY_NAME);
